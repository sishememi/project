...
<tr><td colspan="6"><h3>Etc.</h3></td></tr>
   <c:if test="${boardcnt == 0}">
     ...
     <div class="table102-head">
      <tr class="h">
         <th width="8%" class="ee">번호</th>
         <th width="5%" class="ee">&nbsp;</th>
         <th width="46%" class="ee">제목</th>
         <th width="15%" class="ee">작성자</th>
         <th width="20%" class="ee">작성일</th>
         <th width="11%" class="ee">조회</th>
      </tr>
      </div>
       <c:forEach var="b" items="${list}">
        <tr class="e"><td>${boardnum}</td> <!-- boardnum : 보여주기 식 번호 -->
...
<c:if test="${pageNum < maxpage}">
	<a href="javascript:listdo(${pageNum + 1})">다음</a> 
      ...
      <tr>
         <td colspan="6" style="text-align: right"><a href="etcwrite.do?bsection=3" class="bbb">글쓰기</a></td>
      </tr>
</table>
</form>
...
<input type="submit" class="searchform3" value="검색"></td>
</tr> 
</table>
</form>
</body>
